...
[Gilbert and Whitlock *Submitted*](DOI goes here or url) describes the use of these procedures and their derivation. If you use this method, please cite:

&nbsp;&nbsp;&nbsp; Gilbert KJ and MC Whitlock (*Submitted*) *Q<sub>ST</sub>* *F<sub>ST</sub>* comparisons with unbalanced half-sib designs.
